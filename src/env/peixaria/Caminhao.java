...
public class Caminhao extends Artifact {
	...
	void incrementaEquipe(int idCaminhao, String nomeAgent){
	    ...
	    if(qtEquipe<=2){
	    	prop.updateValue(prop.intValue()+1);
		  	logger.info((Integer) getObsProperty("identificador").getValue()+": Novo membro:"+ nomeAgent +" da Equipe do Caminhão "+ idCaminhao +" adicionado");
	    }else{
	...
	void desligar_motores(){
		...
		logger.info((Integer) getObsProperty("identificador").getValue()+": Motor caminhão desligado!");
	}
